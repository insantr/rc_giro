...
void loop()
{
  ...
  throttle = inc;//(uint8_t) (tx.getChannel(0, 1000, 2000, 0x00, 0xFF ));
  aileron  = inc;//(uint8_t) (tx.getChannel(1, 1000, 2000, 0x00, 0xFF ));
  elevator = inc;//(uint8_t) (tx.getChannel(2, 1000, 2000, 0x00, 0xFF ));
  rudder   = inc;//(uint8_t) (tx.getChannel(3, 1000, 2000, 0x00, 0xFF ));
